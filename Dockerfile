...
# + 指令橋接頁，README、截圖等不進 image
COPY pokemon_footer_widget.html config.js pokemon_heights.js pokemon_types.js pokemon_cameo.js params.html bridge.html /usr/share/nginx/html/
